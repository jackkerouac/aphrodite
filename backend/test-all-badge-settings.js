...
async function checkAllBadgeSettings() {
  try {
    console.log('Checking ALL badge settings in database...\n');
    ...
    console.log('Resolution badge settings (all):');
