...
--
-- Name: unified_badge_settings; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.unified_badge_settings (
    id integer NOT NULL,
    user_id integer NOT NULL,
    badge_type character varying(50) NOT NULL,
    badge_size integer DEFAULT 100,
    edge_padding integer DEFAULT 10,
    badge_position character varying(50) DEFAULT 'top-left'::character varying,
    display_format character varying(20) DEFAULT 'horizontal'::character varying,
    background_color character varying(50) DEFAULT '#000000'::character varying,
    background_opacity integer DEFAULT 80,
    border_size integer DEFAULT 2,
    border_color character varying(50) DEFAULT '#FFFFFF'::character varying,
    border_opacity integer DEFAULT 80,
    border_radius integer DEFAULT 5,
    border_width integer DEFAULT 1,
    shadow_enabled boolean DEFAULT false,
    shadow_color character varying(50) DEFAULT '#000000'::character varying,
...
COMMENT ON TABLE public.unified_badge_settings IS 'Unified table for all badge settings (audio, resolution, review) to ensure consistency';


--
-- Name: unified_badge_settings_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.unified_badge_settings_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: unified_badge_settings_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.unified_badge_settings_id_seq OWNED BY public.unified_badge_settings.id;
...
--
-- Name: unified_badge_settings id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.unified_badge_settings ALTER COLUMN id SET DEFAULT nextval('public.unified_badge_settings_id_seq'::regclass);
...
--
-- Name: unified_badge_settings unified_badge_settings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.unified_badge_settings
    ADD CONSTRAINT unified_badge_settings_pkey PRIMARY KEY (id);


--
-- Name: unified_badge_settings unified_badge_settings_user_id_badge_type_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.unified_badge_settings
    ADD CONSTRAINT unified_badge_settings_user_id_badge_type_key UNIQUE (user_id, badge_type);
...
--
-- Name: unified_badge_settings_badge_type_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX unified_badge_settings_badge_type_idx ON public.unified_badge_settings USING btree (badge_type);


--
-- Name: unified_badge_settings_user_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX unified_badge_settings_user_id_idx ON public.unified_badge_settings USING btree (user_id);
...
--
-- Name: unified_badge_settings update_unified_badge_settings_updated_at_trigger; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_unified_badge_settings_updated_at_trigger BEFORE UPDATE ON public.unified_badge_settings FOR EACH ROW EXECUTE FUNCTION public.update_modified_column();
...
--
-- Name: unified_badge_settings unified_badge_settings_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.unified_badge_settings
    ADD CONSTRAINT unified_badge_settings_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
