...
const PreviewPanel: React.FC<PreviewPanelProps> = ({
  ...
  }, [selectedResolution, resolutionImages]);
        ...
        <div className="flex flex-col gap-4">
          <div className="relative bg-muted rounded-md overflow-hidden" style={{ minHeight: '400px' }}>
            ...
            <div style={getBadgeContainerStyle()}>
              <img
                src={resolutionImages[selectedResolution] || resolutionImages['1080']}
                alt={`${selectedResolution} badge`}
          ...
          <div className="text-sm text-muted-foreground">
            <p>Selected Badge: <span className="font-medium">{selectedResolution}</span></p>
