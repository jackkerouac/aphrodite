...
import { useResolutionBadgeSettings } from './hooks/useResolutionBadgeSettings';
import { resolutionOptions, resolutionImages } from './constants';

const DesignResolutionBadge: React.FC = () => {
  const {
    settings,
    loading,
    error,
